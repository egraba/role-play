...
class Character(models.Model):
    ...
    personality_traits = models.TextField(max_length=150)
    ideals = models.TextField(max_length=150, null=True, blank=True)
    bonds = models.TextField(max_length=150, null=True, blank=True)
    flaws = models.TextField(max_length=150, null=True, blank=True)
