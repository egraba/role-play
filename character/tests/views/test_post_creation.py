...
class TestEquipmentSelectView:
    ...
    @pytest.fixture()
    def setup(self, client, character_fixtures):
    ...
    @pytest.fixture()
    def setup_cleric(self, client, character_fixtures):
    ...
    @pytest.fixture()
    def setup_fighter(self, client, character_fixtures):
    ...
    @pytest.fixture()
    def setup_rogue(self, client, character_fixtures):
    ...
    @pytest.fixture()
    def setup_wizard(self, client, character_fixtures):
