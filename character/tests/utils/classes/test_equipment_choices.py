...
class TestClericEquipmentChoicesProvider:
    def test_get_weapon1_choices(self, character_fixtures):
    ...
    def test_get_weapon2_choices(self, character_fixtures):
        equipment_provider = ClericEquipmentChoicesProvider()
    ...
    def test_get_weapon3_choices(self, character_fixtures):
        equipment_provider = ClericEquipmentChoicesProvider()
        with pytest.raises(NotImplementedError):
            equipment_provider.get_weapon3_choices()

    def test_get_armor_choices(self, character_fixtures):
        equipment_provider = ClericEquipmentChoicesProvider()
    ...
    def test_get_gear_choices(self, character_fixtures):
        equipment_provider = ClericEquipmentChoicesProvider()
    ...
    def test_get_pack_choices(self, character_fixtures):
        equipment_provider = ClericEquipmentChoicesProvider()
